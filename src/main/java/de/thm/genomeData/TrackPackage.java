...
public final class TrackPackage {
    ...
    public enum PackageName {Basic, Expression, Histone, Repeats_by_name, TFBS, OpenChrom, Distance, Named, Strand, Cancer, iPs, safe_harbor, Repeats_by_family, Restriction_sites}
}
