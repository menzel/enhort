...
public class EffectSizeTest {
    ...
    public void testFoldChange() throws Exception {
        ...
        assertEquals(1.325, fc.foldChange(6000, 4000, 4700, 5300), 0.0001);
        assertEquals(3.27, fc.foldChange(1139,5,9021,131), 0.1);
        assertEquals(Double.POSITIVE_INFINITY, fc.foldChange(0,1144,86,9066), 0.1);
        assertEquals(Float.NaN, fc.foldChange(0,0,0,0), 0.0001);
